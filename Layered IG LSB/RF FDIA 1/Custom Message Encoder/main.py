...
BITS_PER_CHAR = 8
CLASS_NAMES = None
RESERVED_BITS = 1300  # First 1024 pixels reserved for coordinate metadata
...
def process_images(folder_path, model_path, output_excel, stego_output_folder, message_length):
    ...
    if df.empty:
        print("❌ No images were successfully processed. Exiting without saving results.")
        return
...
if __name__ == "__main__":
    input_folder = "Layered IG LSB/RF FDIA 1/Images/Attack"
    model_path = "Layered IG LSB/RF FDIA 1/best_rf_model.pkl"
    output_excel = "Layered IG LSB/RF FDIA 1/Custom Message Encoder/Attack/rf_layered_results (5 letters).xlsx"
    stego_output_folder = "Layered IG LSB/RF FDIA 1/Custom Message Encoder/Attack/stego_images (5 letters)"
